...
from rkjo_education.learner.repository import (
    InMemoryLearnerRepository,
)
from rkjo_education.learner.service import (
    LearnerNotFoundError,
    LearnerService,
)
from rkjo_education.learning.repository import (
...
def require_uuid_tenant(
    ...
    try:
        ...
        raise HTTPException(
            status_code=400,
            detail=(
                "Learner operations require "
                "a UUID tenant identifier."
            ),
        ) from exc
